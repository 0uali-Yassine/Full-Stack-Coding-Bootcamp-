...
const students = [
  ...
  // 1. filter() 
  const passeStdnt = students.filter(stdnt => stdnt.isPassed);
  
  console.log(passeStdnt);
  
  // 2. Bonus: 
  passeStdnt.forEach(stdnt => {
    console.log(`Good job ${stdnt.name}, you passed the course in ${stdnt.course}`);
  });
